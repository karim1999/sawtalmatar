...
<div class="col-12">
  ...
  {!!$api['advs']->header_ar!!} 
  @elseif(session('language')!="ar" && session('header_status')!="false" && $api['advs']->header_status==1)
  {!!$api['advs']->header_en!!}
  @endif  
</div>
    ...
    <div class="col-12 px-0 full-height pt-2" style="position: relative;">
            ...
            <div class="col-12 px-0"> 
                    ...
                    <div class="container pt-5 pb-5 mb-5 "> 
                        ...
                        <div class="col-12 px-0 row text-center justify-content-center   pb-5 mb-5 ">
                            ...
                            <div class="d-inline-block px-4 mt-3 home-specialization" style="cursor: pointer;" data-song="{{env('PUBLIC_PATH')}}/sounds/3daks.mp3"> 
                            ...
                            <div class="d-inline-block px-4 mt-3 home-specialization" style="cursor: pointer;" data-song="{{env('PUBLIC_PATH')}}/sounds/despaceto.mp3"> 
                            ...
                            <div class="d-inline-block px-4  mt-3 home-specialization" style="cursor: pointer;" data-song="{{env('PUBLIC_PATH')}}/sounds/m3ak_f_7lmk.mp3"> 
                            ...
                            <div class="d-inline-block px-4  mt-3 home-specialization active" style="cursor: pointer;" data-song="{{env('PUBLIC_PATH')}}/sounds/marron5.mp3"> 
        ...
        <audio  id="audio-matar"> 
          <source src="{{env('PUBLIC_PATH')}}/sounds/3daks.mp3" type="audio/mpeg">
